export const kitchenStrings = {
  ...
  menuSearchPlaceholder: { en: "Search menu items", ar: "ابحث في عناصر القائمة" },
  clearSearch: { en: "Clear search", ar: "مسح البحث" },
  noMenuResults: { en: "No matching menu items", ar: "لا توجد عناصر مطابقة" },
  ...
  timeWindowsLabel: { en: "Service schedule", ar: "جدول التقديم" },
  notAvailableHint: {
    en: "Red hours are blocked. Gray hours are available. Tap any hour to switch it.",
    ar: "الساعات الحمراء محجوبة. الساعات الرمادية متاحة. اضغط على أي ساعة لتغييرها.",
  },
  hoursReset: { en: "Clear blocked hours", ar: "مسح الساعات المحجوبة" },
  hoursAllDay: { en: "Block full day", ar: "حجب اليوم كاملًا" },
  hoursAvailableAllDay: { en: "Available all day", ar: "متوفر طوال اليوم" },
  hoursBlockedSummary: { en: "Blocked hours", ar: "الساعات المحجوبة" },
  hoursMorning: { en: "Morning", ar: "الصباح" },
  hoursAfternoon: { en: "Afternoon / evening", ar: "بعد الظهر / المساء" },
